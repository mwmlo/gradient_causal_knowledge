...
from captum._utils.typing import BaselineType, TargetType, TensorOrTupleOfTensorsGeneric, ModuleOrModuleList
...
class CustomIntegratedGradients(GradientAttribution):
    r"""
    ...
    def attribute(  # type: ignore
        ...
        if internal_batch_size is not None:
            ...
            attributions = _batch_attribution(
                ...
                method=method,
                return_gradient_history=return_gradient_history
            )
        else:
...
class CustomLayerIntegratedGradients(LayerAttribution, GradientAttribution):
    r"""
    ...
    def __init__(
        ...
        GradientAttribution.__init__(self, forward_func)
        self.ig = CustomIntegratedGradients(forward_func, multiply_by_inputs)
